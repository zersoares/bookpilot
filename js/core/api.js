...
export const API = {
  ...
  tiktokCampaigns: () => api.get("/api/bp/tiktok-campaigns"),
  createTikTokCampaign: (payload) => api.post("/api/bp/tiktok-campaigns", payload),
  tiktokSummary: () => api.get("/api/bp/tiktok-import"),
  tiktokImport: (payload) => api.post("/api/bp/tiktok-import", payload),
  tiktokRemove: () => api.delete("/api/bp/tiktok-import"),
